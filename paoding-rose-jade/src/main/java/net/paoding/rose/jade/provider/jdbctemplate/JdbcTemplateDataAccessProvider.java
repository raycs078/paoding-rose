 ...
 */
public abstract class JdbcTemplateDataAccessProvider extends AbstractDataAccessProvider
    ...
    protected final DataAccess createDataAccess(DataSource dataSource) {
        JdbcTemplateDataAccess d = createEmptyJdbcTemplateDataAccess();
        d.setDataSource(dataSource);
        return d;
    }

    protected abstract JdbcTemplateDataAccess createEmptyJdbcTemplateDataAccess();
